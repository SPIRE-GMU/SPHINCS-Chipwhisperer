...
#elif SPX_WOTS_W == 16
    #define SPX_WOTS_LOGW 4 /* this */
#else
    #error SPX_WOTS_W assumed 16 or 256
#endif

#define SPX_WOTS_LEN1 (8 * SPX_N / SPX_WOTS_LOGW) /* 8*32/4 = 64 */
...
/* SPX_WOTS_LEN2 is floor(log(len_1 * (w - 1)) / log(w)) + 1; we precompute */
    ...
    #endif
#elif SPX_WOTS_W == 16 /* this */
    #if SPX_N <= 8
        #define SPX_WOTS_LEN2 2
    #elif SPX_N <= 136
        #define SPX_WOTS_LEN2 3 /* this */
    #elif SPX_N <= 256
...
#define SPX_WOTS_LEN (SPX_WOTS_LEN1 + SPX_WOTS_LEN2) /* 64 + 3 = 67 */
